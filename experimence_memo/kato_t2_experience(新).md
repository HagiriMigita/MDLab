...
v1+v2で学習したcheckpointでv1のテストデータセットをテストした結果  
+----------+-------+--------+--------+-------+-------+-------+  
| category | mAP   | mAP_50 | mAP_75 | mAP_s | mAP_m | mAP_l |   
+----------+-------+--------+--------+-------+-------+-------+  
| person   | 0.044 | 0.156  | 0.015  | 0.039 | 0.138 | 0.128 |  
| car      | 0.249 | 0.54   | 0.201  | 0.1   | 0.514 | 0.732 |  
+----------+-------+--------+--------+-------+-------+-------+

v1+v2で学習したcheckpointでv2のテストデータセットをテストした結果  
+----------+-------+--------+--------+-------+-------+-------+  
| category | mAP   | mAP_50 | mAP_75 | mAP_s | mAP_m | mAP_l |  
+----------+-------+--------+--------+-------+-------+-------+  
| person   | 0.18  | 0.374  | 0.149  | 0.144 | 0.542 | nan   |  
| car      | 0.125 | 0.306  | 0.092  | 0.059 | 0.457 | 0.641 |  
+----------+-------+--------+--------+-------+-------+-------+  

v1+v2で学習したcheckpointでv1+v2のテストデータセットをテストした結果  
+----------+-------+--------+--------+-------+-------+-------+  
| category | mAP   | mAP_50 | mAP_75 | mAP_s | mAP_m | mAP_l |  
+----------+-------+--------+--------+-------+-------+-------+  
| person   | 0.077 | 0.224  | 0.04   | 0.074 | 0.212 | 0.143 |  
...
| category | mAP   | mAP_50 | mAP_75 | mAP_s | mAP_m | mAP_l |  
+----------+-------+--------+--------+-------+-------+-------+  
| person   | 0.072 | 0.229  | 0.026  | 0.063 | 0.185 | 0.11  |  
...
| category | mAP   | mAP_50 | mAP_75 | mAP_s | mAP_m | mAP_l |  
+----------+-------+--------+--------+-------+-------+-------+  
| person   | 0.115 | 0.292  | 0.07   | 0.106 | 0.287 | 0.105 |  
| car      | 0.3   | 0.573  | 0.282  | 0.203 | 0.547 | 0.702 |  
+----------+-------+--------+--------+-------+-------+-------+  
...
| category | mAP   | mAP_50 | mAP_75 | mAP_s | mAP_m | mAP_l |  
+----------+-------+--------+--------+-------+-------+-------+  
| person   | 0.036 | 0.135  | 0.008  | 0.034 | 0.1   | 0.172 |  
...
| car      | 0.138 | 0.308  | 0.115  | 0.07  | 0.506 | 0.547 |  
+----------+-------+--------+--------+-------+-------+-------+  
...
| category | mAP   | mAP_50 | mAP_75 | mAP_s | mAP_m | mAP_l |  
+----------+-------+--------+--------+-------+-------+-------+  
| person   | 0.07  | 0.204  | 0.033  | 0.066 | 0.187 | 0.171 |  
...
- v1(デフォルトの損失関数)でv1テスト  
+----------+-------+--------+--------+-------+-------+-------+  
| category | mAP   | mAP_50 | mAP_75 | mAP_s | mAP_m | mAP_l |  
+----------+-------+--------+--------+-------+-------+-------+  
| person   | 0.027 | 0.127  | 0.002  | 0.032 | 0.08  | 0.089 |  
| car      | 0.278 | 0.554  | 0.255  | 0.112 | 0.52  | 0.726 |  
+----------+-------+--------+--------+-------+-------+-------+  
