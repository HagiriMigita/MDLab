...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        while cap.isOpened():
            ...
            if elapsed_time >= 1.0:
                print(f"Frames processed in the last second: {frame_count}")
                frame_count = 0
                start_time = time.time()
            ...
            eyes_center = model.get_eyes_center(frame)
            ...
            if 'sad' in label and eyes_center is not None:
                frame.flags.writeable = True
